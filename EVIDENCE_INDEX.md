...
| AWS plan, zero spend | [AWS execution plan](docs/phase_9/PHASE_9A_AWS_EXECUTION_PLAN.md), [cost report](AWS_COST_REPORT.md) |
...
- [Mission and pipeline overview](docs/images/dashboard-overview-v1.png)
- [Bounded geospatial explorer](docs/images/dashboard-geospatial-v1.png)
- [Detection lineage](docs/images/dashboard-lineage-v1.png)
